...
<head>
	<meta charset="utf-8">
	<title>Adicionar investimentos</title>
	...
	<section>
		<div class="container">
			<div class="card">
				...
				<div class="card-body">
					<form class="form-group" action="backend.php?acao=inserir" method="post" required>
						
						<label for="cod">Código da empresa</label>
						<input type="text" name="cod" class="form-control" placeholder="Ex: CCRO3" required pattern="^[A-z]{4}[1-9]{1}[0-9]{0,1}$">
						<label class="mt-2" for="cnpj">Cnpj da empresa</label>
						<input type="text" name="cnpj" class="form-control cnpj" placeholder="Ex: 12.345.678/0002-00" required pattern="^[0-9]{2}.[0-9]{3}.[0-9]{3}/[0-9]{4}-[0-9]{2}$">
						<label class="mt-2" for="preco_ativo">Preço da ação</label>
						<input type="text" name="preco_ativo" class="form-control valor" required placeholder="Ex: 12,50">
						<label class="mt-2" for="quant_ativo">Quantidade adquirida</label>
						<input type="text" name="quant_ativo" class="form-control" required pattern="^[1-9]\d*" placeholder="Ex: 100">
